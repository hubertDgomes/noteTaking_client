  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100 w-full max-w-md">
        <h2 className="text-2xl font-bold text-slate-800 mb-1 text-center">Welcome Back</h2>
        <p className="text-slate-500 text-sm text-center mb-6">Log in to manage your notes securely</p>
